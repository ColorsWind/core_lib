package io.github.divios.core_lib.multiblock;
...
public class MultiBlockStructure {
     ...
     */
    public int buildAsync(Plugin plugin, Location loc, int relX, int relY, int relZ, int rotation, boolean mirror, int blocksPerTick, Consumer<Structure> callback) {
     ...
     * @return The task number for the Bukkit scheduler task created by this method
     */
    public int buildAsync(Plugin plugin, Location loc, int rotation, boolean mirror, int blocksPerTick, Consumer<Structure> callback) {
        return buildAsync(plugin, loc, 0, 0, 0, rotation, mirror, blocksPerTick, callback);
    }
     ...
     * @return The task number for the Bukkit scheduler task created by this method
     */
    public int buildAsync(Plugin plugin, Location loc, int rotation, int blocksPerTick, Consumer<Structure> callback) {
        return buildAsync(plugin, loc, 0, 0, 0, rotation, false, blocksPerTick, callback);
    }
     ...
     * @return The task number for the Bukkit scheduler task created by this method
     */
    public int buildAsync(Plugin plugin, Location loc, int blocksPerTick, Consumer<Structure> callback) {
        return buildAsync(plugin, loc, 0, 0, 0, 0, false, blocksPerTick, callback);
    }
