...
import io.github.divios.core_lib.multiblock.Rotator;
...
public class SpheroidRegion extends Region {
    ...
    /**
     * @return A String representation of this SpheroidRegion which can later be deserialized with {@link SpheroidRegion#fromString(Plugin, String)}
     */
    @Override
