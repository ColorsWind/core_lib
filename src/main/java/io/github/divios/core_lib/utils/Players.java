...
public final class Players {
    ...
    public static Player getNullable(UUID uuid) {
        return Core_lib.getPlugin().getServer().getPlayer(uuid);
    }
    ...
    public static Player getNullable(String username) {
        ...
        return Core_lib.getPlugin().getServer().getPlayerExact(username);
    }
    ...
    public static void msg(CommandSender sender, String... msgs) {
        for (String s : msgs) {
            sender.sendMessage(FormatUtils.color(s));
        }
    }

    @Nullable
    public static OfflinePlayer getOfflineNullable(UUID uuid) {
        return Core_lib.getPlugin().getServer().getOfflinePlayer(uuid);
    }
    ...
    public static OfflinePlayer getOfflineNullable(String username) {
        //noinspection deprecation
        return Core_lib.getPlugin().getServer().getOfflinePlayer(username);
    }
