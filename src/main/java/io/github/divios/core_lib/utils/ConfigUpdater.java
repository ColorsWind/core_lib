...
public class ConfigUpdater {
     ...
     */
    public static void update(String resourceName, File toUpdate, List<String> ignoredSections) throws IOException {
        BufferedReader newReader = new BufferedReader(new InputStreamReader(Core_lib.getPlugin().getResource(resourceName), StandardCharsets.UTF_8));
        ...
        FileConfiguration newConfig = YamlConfiguration.loadConfiguration(new InputStreamReader(Core_lib.getPlugin().getResource(resourceName), StandardCharsets.UTF_8));
